...
pub struct Window {
    ...
    pub(crate) input_rate_tracker: Rc<RefCell<crate::input_rate_tracker::InputRateTracker>>,
...
impl Window {
    pub(crate) fn new(
        ...
        let input_rate_tracker = Rc::new(RefCell::new(
            crate::input_rate_tracker::InputRateTracker::new(),
        ));
        ...
        platform_window.on_request_frame(Box::new({
            ...
            move |request_frame_options| {
                ...
                // Only keep presenting (VRR keepalive) when input arrives at
                // a sustained high rate (>=60/s), not on every casual mouse move.
...
impl Window {
    ...
    pub fn dispatch_event(&mut self, event: PlatformInput, cx: &mut App) -> DispatchEventResult {
        ...
        // Only record for VRR rate tracking when the input actually dirtied
        // the window (caused a re-render). Casual mouse moves that don't change
        // anything won't trigger sustained frame presentation.
