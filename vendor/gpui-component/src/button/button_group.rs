use gpui::{
  App, Axis, Corners, Edges, ElementId, InteractiveElement, IntoElement, ParentElement, RenderOnce,
...
impl RenderOnce for ButtonGroup {
  fn render(self, _: &mut Window, _: &mut App) -> impl IntoElement {
    ...
    div()
      ...
      .children(self.children.into_iter().enumerate().map(|(child_index, child)| {
        ...
        let child = if children_len == 1 {
          ...
          child
            ...
            .border_edges(Edges { left: true, top: true, right: true, bottom: true })
        } else if child_index == children_len - 1 {
          // Last
          child
            .border_edges(Edges { left: vertical, top: !vertical, right: true, bottom: true })
            .border_corners(Corners {
              top_left: false,
              top_right: !vertical,
              bottom_left: vertical,
          ...
          // Middle
          child.border_corners(Corners::all(false)).border_edges(Edges {
            left: vertical,
            top: !vertical,
            right: true,
            bottom: true,
