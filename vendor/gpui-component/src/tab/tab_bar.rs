  ...
  fn render(self, _: &mut Window, cx: &mut App) -> impl IntoElement {
    ...
    let (bg, paddings, gap) = match self.variant {
      ...
      TabVariant::Segmented => {
        ...
        let padding = Edges { left: padding_x, right: padding_x, ..Default::default() };
    ...
    self
      ...
      .when(self.variant == TabVariant::Underline || self.variant == TabVariant::Tab, |this| {
        this.child(
          div()
            .id("border-b")
            .absolute()
      ...
      .when(self.variant == TabVariant::Pill || self.variant == TabVariant::Segmented, |this| {
      ...
      .child(
        h_flex()
          ...
          .flex_1()
          .overflow_x_scroll()
          .when_some(self.scroll_handle, |this, scroll_handle| this.track_scroll(&scroll_handle))
          .gap(gap)
          .children(self.children.into_iter().enumerate().map(|(ix, child)| {
            ...
            child
              ...
              .with_size(self.size)
              .when_some(self.selected_index, |this, selected_ix| this.selected(selected_ix == ix))
              .when_some(self.on_click.clone(), move |this, on_click| {
                this.on_click(move |_, window, cx| on_click(&ix, window, cx))
              })
          }))
          .when(self.suffix.is_some() || self.menu, |this| this.child(self.last_empty_space)),
      )
      .when(self.menu, |this| {
        this.child(
          Button::new("more")
