...
impl Language {
  ...
  pub(super) fn config(&self) -> LanguageConfig {
    ...
    let (language, query, injection, locals) = match self {
      Self::Json => {
        (tree_sitter_json::LANGUAGE, include_str!("languages/json/highlights.scm"), "", "")
      }
    };
    ...
    let (language, query, injection, locals) = match self {
      ...
      Self::Toml => (tree_sitter_toml_ng::LANGUAGE, tree_sitter_toml_ng::HIGHLIGHTS_QUERY, "", ""),
      ...
      Self::Go => (tree_sitter_go::LANGUAGE, include_str!("languages/go/highlights.scm"), "", ""),
      ...
      Self::JsDoc => (tree_sitter_jsdoc::LANGUAGE, tree_sitter_jsdoc::HIGHLIGHTS_QUERY, "", ""),
      Self::Zig => (
      ...
      Self::Python => (tree_sitter_python::LANGUAGE, tree_sitter_python::HIGHLIGHTS_QUERY, "", ""),
      Self::Ruby => (
      ...
      Self::Sql => (tree_sitter_sequel::LANGUAGE, tree_sitter_sequel::HIGHLIGHTS_QUERY, "", ""),
    ...
    LanguageConfig::new(self.name(), language, self.injection_languages(), query, injection, locals)
  }
}
